...
function ProfileEdit({data}:{data:any}) {
    ...
    <div className="grid w-full h-full place-items-center">
         <Card className="max-w-[400px]  md:max-w-[500px]">
          ...
          <CardHeader>
           ...
           <p>
          Rassurez-vous de remplir correctement le formulaire d'inscription ci-dessous  avec les informations fiables. En particulier votre adresse mail fournie doit être correcte et accessible permettant de vous contacter en cas de besoin.
           </p>
            </CardDescription>
          </CardHeader>
          <CardContent>
