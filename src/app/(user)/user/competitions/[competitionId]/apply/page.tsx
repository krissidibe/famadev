...
async function Home({
 ...
 const user: any = await res1.json();  
  ...
  file.data.statut == "1" ?  <ApplyItem data={{data:user,competitionId:params.competitionId,fileAttach:fileAttach,filesRequired: file.data.filesRequired,inputsRequired: file.data.inputsRequired,groupsRequired: file.data.groupsRequired,groupsRequiredParent: file.data.groupsRequiredParent}} />   : <div>
    Non disponible
  </div>
